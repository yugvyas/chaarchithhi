...
const MOCK_FINAL_SCORES = [
  { id: 1, name: "You", score: 4500 },
  { id: 2, name: "Priya", score: 3200 },
  { id: 3, name: "Raj", score: 2800 },
  { id: 4, name: "Amit", score: 1500 },
];
...
export default function FinalResultsScreen() {
  ...
  const winner = MOCK_FINAL_SCORES.sort((a, b) => b.score - a.score)[0];
    ...
    <div className="min-h-screen w-full bg-[#8B6F47] relative overflow-hidden flex flex-col items-center justify-center p-6"
      ...
      {showConfetti && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          {[...Array(30)].map((_, i) => (
            <div
              key={i}
              className="absolute bg-[#FFF8E7] border-2 border-[#2C1810] animate-confetti"
              style={{
      ...
      <div className="max-w-md w-full z-10">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-5xl text-[#FFF8E7] mb-3 transform -rotate-2"
        ...
        <div className="bg-[#FFF8E7] border-4 border-[#2C1810] p-8 transform -rotate-1 shadow-lg mb-8"
          ...
          {/* Title */}
          <h2 className="text-3xl text-[#2C1810] text-center mb-6"
              style={{ fontFamily: 'Caveat, cursive', fontWeight: 700 }}>
            Final Scores
          </h2>
          ...
          <div className="space-y-4">
            {MOCK_FINAL_SCORES.sort((a, b) => b.score - a.score).map((player, index) => (
              <div
                key={player.id}
                ...
                <div className="text-3xl text-[#D2691E]"
                     style={{ fontFamily: 'Patrick Hand, cursive' }}>
                  {player.score}
                </div>
              </div>
